        ...
        <div className="flex justify-center items-center mt-14 w-full">
          <nav className="flex items-center gap-1 bg-white p-1.5 rounded border border-slate-200/60 shadow-sm transition-all hover:shadow-md">
            ...
            <button
              ...
              className="flex items-center justify-center w-10 h-10 rounded text-slate-500 transition-all hover:bg-slate-50 hover:text-slate-900 disabled:opacity-20 disabled:hover:bg-transparent active:scale-95"
            >
